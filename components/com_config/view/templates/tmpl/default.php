...
JFactory::getDocument()->addScriptDeclaration("
	Webdata.submitbutton = function(task)
	{
		...
		{
			Webdata.submitform(task, document.getElementById('templates-form'));
		}
	}
");
?>
...
<form action="<?php echo JRoute::_('index.php?option=com_config'); ?>" method="post" name="adminForm" id="templates-form" class="form-validate">
	...
	<div class="row-fluid">
		...
		<div class="btn-toolbar" role="toolbar" aria-label="<?php echo JText::_('JTOOLBAR'); ?>">
			<div class="btn-group">
				<button type="button" class="btn btn-primary" onclick="Webdata.submitbutton('config.save.templates.apply')">
					<span class="icon-ok"></span> <?php echo JText::_('JSAVE') ?>
				</button>
			</div>
			<div class="btn-group">
				<button type="button" class="btn" onclick="Webdata.submitbutton('config.cancel')">
