...
JFactory::getDocument()->addScriptDeclaration("
	Webdata.submitbutton = function(task)
	{
		...
		{
			Webdata.submitform(task, document.getElementById('modules-form'));
		}
	}
");
?>
			...
			<div class="btn-toolbar" role="toolbar" aria-label="<?php echo JText::_('JTOOLBAR'); ?>">
				<div class="btn-group">
					<button type="button" class="btn btn-primary"
						onclick="Webdata.submitbutton('config.save.modules.apply')">
				...
				<div class="btn-group">
					<button type="button" class="btn"
						onclick="Webdata.submitbutton('config.save.modules.save')">
				...
				<div class="btn-group">
					<button type="button" class="btn"
						onclick="Webdata.submitbutton('config.cancel.modules')">
