...
abstract class JHtmlIcon
{
	...
	public static function create($category, $params, $attribs = array(), $legacy = false)
	{
		...
		$text = JLayoutHelper::render('webdata.content.icons.create', array('params' => $params, 'legacy' => $legacy));
	...
	public static function email($article, $params, $attribs = array(), $legacy = false)
	{
		...
		$text = JLayoutHelper::render('webdata.content.icons.email', array('params' => $params, 'legacy' => $legacy));
	...
	public static function edit($article, $params, $attribs = array(), $legacy = false)
	{
			...
			&& $article->checked_out != $user->get('id'))
		{
			...
			$text = JLayoutHelper::render('webdata.content.icons.edit_lock', array('tooltip' => $tooltip, 'legacy' => $legacy));
		...
		$text = JLayoutHelper::render('webdata.content.icons.edit', array('article' => $article, 'overlib' => $overlib, 'legacy' => $legacy));
	...
	public static function print_popup($article, $params, $attribs = array(), $legacy = false)
	{
		...
		$text = JLayoutHelper::render('webdata.content.icons.print_popup', array('params' => $params, 'legacy' => $legacy));
	...
	{
		$text = JLayoutHelper::render('webdata.content.icons.print_screen', array('params' => $params, 'legacy' => $legacy));
