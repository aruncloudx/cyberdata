...
class PlgSystemDebug extends JPlugin
{
	...
	public function __construct(&$subject, $config)
	{
		...
		// Get the application if not done by JPlugin. This may happen during upgrades from Webdata 2.5.
		if (!$this->app)
		{
	...
	{
		return JLayoutHelper::render('webdata.error.backtrace', array('backtrace' => $error->getTrace()));
	}

	/**
	 * Replaces the Webdata! root with "JROOT" to improve readability.
