...
/**
 * Statistics system plugin. This sends anonymous data back to the Webdata! Project about the
 * PHP, SQL, Webdata and OS versions
 *
 * @since  3.5
 */
class PlgSystemStats extends JPlugin
{
	 ...
	 * @since  3.5
	 */
	protected $serverUrl = 'https://developer.webdata.org/stats/submit';
