...
JFactory::getDocument()->addScriptDeclaration('
	Webdata.submitbuttonpackage = function()
	{
...
<div id="legacy-uploader" style="display: none;">
	...
	<div class="form-actions">
		<button class="btn btn-primary" type="button" id="installbutton_package" onclick="Webdata.submitbuttonpackage()">
