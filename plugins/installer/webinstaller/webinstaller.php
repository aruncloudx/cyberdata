...
{
	public $appsBaseUrl = 'https://appscdn.webdata.org/webapps/';
...
jQuery(document).ready(function() {
	...
	jQuery(eventpoint).click(function (event){
		if (!Webdata.apps.loaded) {
			Webdata.apps.initialize();
		}
	});
			...
			<fieldset class="uploadform">
				...
				<fieldset class="uploadform" id="uploadform-web" style="display:none"<?php echo $dir; ?>>
					...
					<div class="form-actions">
						<input type="button" class="btn btn-primary" value="<?php echo JText::_('COM_INSTALLER_INSTALL_BUTTON'); ?>" onclick="Webdata.submitbutton<?php echo $installfrom != '' ? 4 : 5; ?>()" />
						<input type="button" class="btn btn-secondary" value="<?php echo JText::_('JCANCEL'); ?>" onclick="Webdata.installfromwebcancel()" />
					</div>
				</fieldset>
			</fieldset>
<?php
