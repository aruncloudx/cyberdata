 ...
 * @subpackage  Quickicon.Webdataupdate
 *
 ...
 * @since  2.5
 */
class PlgQuickiconWebdataupdate extends JPlugin
{
	/**
	...
	public function onGetIcons($context)
	{
		...
		$url = JUri::base() . 'index.php?option=com_webdataupdate';
		$ajax_url = JUri::base() . 'index.php?option=com_installer&view=update&task=update.ajax&' . $token;
		$script = array();
		$script[] = 'var plg_quickicon_webdataupdate_url = \'' . $url . '\';';
		$script[] = 'var plg_quickicon_webdataupdate_ajax_url = \'' . $ajax_url . '\';';
		$script[] = 'var plg_quickicon_jupdatecheck_jversion = \'' . JVERSION . '\'';
		$script[] = 'var plg_quickicon_webdataupdate_text = {'
			...
			. '};';
		$script[] = 'var plg_quickicon_webdataupdate_img = {'
		...
		JHtml::_('script', 'plg_quickicon_webdataupdate/jupdatecheck.js', array('version' => 'auto', 'relative' => true));

		return array(
			array(
				'link' => 'index.php?option=com_webdataupdate',
				'image' => 'webdata',
				'icon' => 'header/icon-48-download.png',
				'text' => JText::_('PLG_QUICKICON_JOOMLAUPDATE_CHECKING'),
				'id' => 'plg_quickicon_webdataupdate',
