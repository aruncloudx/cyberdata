 ...
 * @subpackage  Authentication.webdata
 *
...
/**
 * Webdata Authentication plugin
 *
 * @since  1.5
 */
class PlgAuthenticationWebdata extends JPlugin
{
	/**
	...
	{
		$response->type = 'Webdata';

		// Webdata does not like blank passwords
