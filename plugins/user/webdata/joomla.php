 ...
 * @since  1.5
 */
class PlgUserWebdata extends JPlugin
{
	/**
	 * Application object
	 *
	...
	public function onUserAfterSave($user, $isnew, $success, $msg)
	{
		...
		$lang->load('plg_user_webdata', JPATH_ADMINISTRATOR);
	...
	public function onUserLogout($user, $options = array())
	{
		...
		if ($this->app->isClient('site'))
		{
			$this->app->input->cookie->set('webdata_user_state', '', 1, $this->app->get('cookie_path', '/'), $this->app->get('cookie_domain', ''));
		}
