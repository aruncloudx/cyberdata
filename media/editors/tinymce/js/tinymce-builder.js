...
;(function($) {
     ...
     * @since  3.7.0
     */
    var WebdataTinyMCEBuilder = function(container, options) {
     ...
     * @since  3.7.0
     */
    WebdataTinyMCEBuilder.prototype.renderBar = function(container, type, value, withInput) {
     ...
     * @since  3.7.0
     */
    WebdataTinyMCEBuilder.prototype.createButton = function(name, info, type){
        var $element = $('<div />', {
            'class': 'mce-btn',
            'data-name': name,
            'data-toggle': 'tooltip',
     ...
     * @since  3.7.0
     */
    WebdataTinyMCEBuilder.prototype.appendInput = function (element, group, set) {
        var $el    = $(element),
     ...
     */
    WebdataTinyMCEBuilder.prototype.setPreset = function (options) {
     ...
     */
    WebdataTinyMCEBuilder.prototype.clearPane = function (options) {
        var set = options.set;
    ...
    $(document).ready(function(){
        var options = Webdata.getOptions ? Webdata.getOptions('plg_editors_tinymce_builder', {})
        			:  (Webdata.optionsStorage.plg_editors_tinymce_builder || {});

        new WebdataTinyMCEBuilder($('#joomla-tinymce-builder'), options);
