...
class PostinstallModelMessages extends FOFModel
{
	...
	public function getComponentOptions()
	{
		...
		JFactory::getLanguage()->load('files_webdata.sys', JPATH_SITE, null, false, false);
	 ...
	 *                     the user. @see FOFTemplateUtils::parsePath() for RAD path format. Webdata! will include this file before calling
	 ...
	 *              for RAD path format. Webdata! will include this file before calling the function defined in the action key below.
	 *              Example:   admin://components/com_foobar/helpers/postinstall.php
	 *
