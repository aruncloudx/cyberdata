...
Webdata.submitbutton = function(task, type){
	if (task == 'item.setType' || task == 'item.setMenuType')
	{
		...
		Webdata.submitform('item.setType', document.getElementById('item-form'));
	...
	<div class="form-horizontal">
		...
		<div class="row-fluid">
			...
			<div class="span3">
				...
				echo JLayoutHelper::render('webdata.edit.global', $this); ?>
			</div>
		</div>
