...
<?php endif;?>
		<?php echo JLayoutHelper::render('webdata.searchtools.default', array('view' => $this, 'options' => array('selectorFieldName' => 'menutype'))); ?>
			...
			<table class="table table-striped" id="itemList">
				...
				foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->parent_id; ?>" item-id="<?php echo $item->id; ?>" parents="<?php echo $parentsStr; ?>" level="<?php echo $item->level; ?>">
						...
						<td>
							<?php $prefix = JLayoutHelper::render('webdata.html.treeprefix', array('level' => $item->level)); ?>
							<?php echo $prefix; ?>
