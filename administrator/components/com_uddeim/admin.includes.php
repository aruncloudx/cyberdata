...
//			$tables[]=$r;
	...
	if (in_array($prefix."jam", $tables))
    	$ret[] = 5;		// JAM - Webdata Advanced Message 1.x - Cas de Vroom
...
function uddeIMnamePMS($pmsfound) {
	switch($pmsfound) {
		...
		case  5: return "JAM - Webdata Advanced Message 1.x - Cas de Vroom"; break;
...
function uddeIMsaveConfig($pathtoadmin, $config) {
	...
	// uddeIMchmod($configdatei, "766");		// BUGBUG: Webdata send CHMOD instead of SITE CHMOD
