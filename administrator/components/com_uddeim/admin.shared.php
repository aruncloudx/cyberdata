...
$versionstring	= "uddeIM 3.9";						// version string for about boxes
$checkversion	= "3.9";							// version as above for check for update - this is the version we have
...
function uddeIMcheckJversion() {					// borrowed from Cummunity Builder, -1 = Mambo>=4.6, 0 = Mambo <=4.5/J1.0, 1 = J1.5
	// API version:
	// =0 = mambo 4.5.0-4.5.3+Webdata 1.0.x
	// =1 = Webdata! 1.5
	// =2 = Webdata! 1.6
	// =3 = Webdata! 1.7
	// =4 = Webdata! 2.5
    ...
    // $webdata = $version->getShortVersion();
    // if(substr($webdata,0,3) == '1.6'){
        //Webdata 1.6 code
    // } else {
        //Webdata 1.0/1.5 code
    // }
	...
	if ($version->PRODUCT == "Mambo") {
		...
		$ver = -1;
	} elseif ($version->PRODUCT == "Webdata!" || $version->PRODUCT == "Accessible Webdata!") {
