...
<div class="container-popup">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_fields&view=fields&layout=modal&tmpl=component&' . JSession::getFormToken() . '=1'); ?>" method="post" name="adminForm" id="adminForm">
		...
		<?php echo JLayoutHelper::render('webdata.searchtools.default', array('view' => $this)); ?>
				...
				<tbody>
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<td class="has-context">
							<a class="btn btn-small btn-block btn-success" href="#" onclick="Webdata.fieldIns('<?php echo $this->escape($item->id); ?>', '<?php echo $this->escape($editor); ?>');"><?php echo $this->escape($item->title); ?></a>
						</td>
						<td class="small hidden-phone">
							<a class="btn btn-small btn-block btn-warning" href="#" onclick="Webdata.fieldgroupIns('<?php echo $this->escape($item->group_id); ?>', '<?php echo $this->escape($editor); ?>');"><?php echo $item->group_id ? $this->escape($item->group_title) : JText::_('JNONE'); ?></a>
						</td>
						<td class="small hidden-phone">
							<?php echo $item->type; ?>
						</td>
						...
						<td class="small hidden-phone">
							<?php echo JLayoutHelper::render('webdata.content.language', $item); ?>
						</td>
