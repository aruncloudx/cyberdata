...
JFactory::getDocument()->addScriptDeclaration('
	Webdata.submitbutton = function(task)
	{
		if (task == "newsfeed.cancel" || document.formvalidator.isValid(document.getElementById("newsfeed-form"))) {
			Webdata.submitform(task, document.getElementById("newsfeed-form"));
...
// Fieldsets to not automatically render by /layouts/webdata/edit/params.php
...
<form action="<?php echo JRoute::_('index.php?option=com_newsfeeds&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="newsfeed-form" class="form-validate">
	...
	<?php echo JLayoutHelper::render('webdata.edit.title_alias', $this); ?>
	...
	<div class="form-horizontal">
		...
		<div class="row-fluid">
			...
			<div class="span3">
				<?php echo JLayoutHelper::render('webdata.edit.global', $this); ?>
			</div>
		</div>
		...
		<?php echo JLayoutHelper::render('webdata.edit.params', $this); ?>

		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'publishing', JText::_('JGLOBAL_FIELDSET_PUBLISHING')); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo JLayoutHelper::render('webdata.edit.publishingdata', $this); ?>
			</div>
			<div class="span6">
				<?php echo JLayoutHelper::render('webdata.edit.metadata', $this); ?>
			</div>
		</div>
		<?php echo JHtml::_('bootstrap.endTab'); ?>
