 ...
 *
 * This file contains post-installation message handling for Webdata 4.0 pre checks
 */

defined('_JEXEC') or die;

/**
 * Checks if the installation meats the current requirements for Webdata 4
 *
 * @return  boolean  True if any check fails.
 *
 * @since   3.7
 *
 * @link    https://developer.webdata.org/news/658-webdata4-manifesto.html
 */
function admin_postinstall_webdata40checks_condition()
{
	$db            = JFactory::getDbo();
