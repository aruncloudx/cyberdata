...
class UsersModelUser extends JModelAdmin
{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		if (JPluginHelper::isEnabled('user', 'webdata'))
		{
			$plugin = JPluginHelper::getPlugin('user', 'webdata');
		...
		// Passwords fields are required when mail to user is set to No in webdata user plugin
