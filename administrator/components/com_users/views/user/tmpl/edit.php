...
JFactory::getDocument()->addScriptDeclaration("
	Webdata.submitbutton = function(task)
	{
		...
		{
			Webdata.submitform(task, document.getElementById('user-form'));
		}
	};

	Webdata.twoFactorMethodChange = function(e)
	{
...
<form action="<?php echo JRoute::_('index.php?option=com_users&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="user-form" class="form-validate form-horizontal" enctype="multipart/form-data">
	...
	<?php echo JLayoutHelper::render('webdata.edit.item_title', $this); ?>
	...
	<fieldset>
		<?php echo JHtml::_('bootstrap.startTabSet', 'myTab', array('active' => 'details')); ?>
			...
			echo JLayoutHelper::render('webdata.edit.params', $this);
			?>
		...
		<div class="control-group">
			...
			<div class="controls">
				<?php echo JHtml::_('select.genericlist', Usershelper::getTwoFactorMethods(), 'jform[twofactor][method]', array('onchange' => 'Webdata.twoFactorMethodChange()'), 'value', 'text', $this->otpConfig->method, 'jform_twofactor_method', false); ?>
			</div>
		</div>
