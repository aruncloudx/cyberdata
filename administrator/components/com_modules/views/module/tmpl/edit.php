...
$script .= "
			Webdata.submitform(task, document.getElementById('module-form'));
	...
	<div class="form-horizontal">
		...
		<div class="row-fluid">
			<div class="span9">
				<?php if ($this->item->xml) : ?>
					<?php if ($this->item->xml->description) : ?>
						...
						<div>
							...
							$long_description = JLayoutHelper::render('webdata.edit.fieldset', $this);
							if (!$long_description) {
				...
				$this->fieldset = 'basic';
				$html = JLayoutHelper::render('webdata.edit.fieldset', $this);
				echo $html ? '<hr />' . $html : '';
				?>
			</div>
			<div class="span3">
