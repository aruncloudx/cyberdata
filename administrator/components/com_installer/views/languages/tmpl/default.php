				...
				foreach ($this->items as $language) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						<td>
							...
							<?php $onclick = 'document.getElementById(\'install_url\').value = \'' . $language->detailsurl . '\'; Webdata.submitbutton(\'install.install\');'; ?>
						...
						<td class="center">
								<?php // Display a Note if language pack version is not equal to Webdata version ?>
