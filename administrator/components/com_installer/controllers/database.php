...
class InstallerControllerDatabase extends JControllerLegacy
{
	...
	public function fix()
	{
		...
		// Purge updates
		JModelLegacy::addIncludePath(JPATH_ADMINISTRATOR . '/components/com_webdataupdate/models', 'WebdataupdateModel');
		$updateModel = JModelLegacy::getInstance('default', 'WebdataupdateModel');
		$updateModel->purge();
