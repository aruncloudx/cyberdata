...
JFactory::getDocument()->addScriptDeclaration(
	"
		Webdata.submitbutton = function(task)
		{
			...
			{
				Webdata.submitform(task, document.getElementById('config-form'));
			}
		};
	"
);
...
<div class="container-popup">
	<form action="<?php echo JRoute::_('index.php?option=com_messages&view=config'); ?>" method="post" name="adminForm" id="message-form" class="form-validate form-horizontal">
		...
		<button id="saveBtn" type="button" class="hidden" onclick="Webdata.submitform('config.save', this.form);"></button>
