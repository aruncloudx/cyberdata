...
$js               = <<< JS
	Webdata.submitbuttonUpload = function() {
	...
	jQuery(document).ready(function($) {
		var outerDiv = $("#webdataupdate-wrapper");
...
<div class="alert alert-info">
	<p>
		...
		<?php echo JText::sprintf('COM_JOOMLAUPDATE_VIEW_DEFAULT_UPLOAD_INTRO', 'https://downloads.webdata.org/latest'); ?>
	</p>
</div>
	...
	<fieldset class="uploadform">
		...
		<table class="table table-striped">
			...
			<tr>
				...
				<td>
					<button class="btn btn-primary" type="button" onclick="Webdata.submitbuttonUpload()"><?php echo JText::_('COM_INSTALLER_UPLOAD_AND_INSTALL'); ?></button>
				</td>
			</tr>
			</tfoot>
		</table>
