...
JHtml::_('script', 'com_webdataupdate/default.js', array('version' => 'auto', 'relative' => true));
...
<div id="webdataupdate-wrapper">

	<?php if ($this->showUploadAndUpdate) : ?>
		<?php echo JHtml::_('bootstrap.startTabSet', 'webdataupdate-tabs', array('active' => 'online-update')); ?>
		<?php echo JHtml::_('bootstrap.addTab', 'webdataupdate-tabs', 'online-update', JText::_('COM_JOOMLAUPDATE_VIEW_DEFAULT_TAB_ONLINE')); ?>
	<?php endif; ?>
	...
	<form enctype="multipart/form-data" action="index.php" method="post" id="adminForm" class="form-horizontal">
		...
		<input type="hidden" name="option" value="com_webdataupdate" />
	...
	<?php if ($this->showUploadAndUpdate) : ?>
		...
		<?php echo JHtml::_('bootstrap.addTab', 'webdataupdate-tabs', 'upload-update', JText::_('COM_JOOMLAUPDATE_VIEW_DEFAULT_TAB_UPLOAD')); ?>
	...
	<div class="download_message" style="display: none">
		...
		<div class="webdataupdate_spinner"></div>
	</div>
	<div id="loading"></div>
</div>
