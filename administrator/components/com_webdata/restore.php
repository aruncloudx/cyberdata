 ...
 * and propagation. Largely based on the Webdata! 1.5 JObject class.
 */
abstract class AKAbstractObject
{
	 ...
	 * JObject instance in Webdata!. Propagated items will be removed from ourself.
	 *
		...
		if ($object->getState() == 'init')
		{
			...
			if (!defined('KICKSTART'))
			{
				...
				$moreSkippedFiles     = array(
					// Akeeba Backup for Webdata!
					'administrator/components/com_akeeba/restoration.php',
					// Webdata! Update
					'administrator/components/com_webdataupdate/restoration.php',
