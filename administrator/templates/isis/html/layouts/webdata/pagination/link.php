...
{
	$options = new Webdata\Registry\Registry($displayData['pagOptions']);
...
if ($displayData['active'])
{
	...
	$onClick = 'document.adminForm.' . $item->prefix . 'limitstart.value=' . ($item->base > 0 ? $item->base : '0') . '; Webdata.submitform();return false;';
}
else
{
