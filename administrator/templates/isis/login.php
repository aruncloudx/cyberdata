...
<body class="site <?php echo $option . ' view-' . $view . ' layout-' . $layout . ' task-' . $task . ' itemid-' . $itemid . ' '; ?>">
	...
	<div class="container">
		<div id="content">
			...
			<div id="element-box" class="login well">
				...
				<?php else: ?>
					<img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/webdata.png" alt="<?php echo $sitename; ?>" />
				<?php endif; ?>
				<hr />
	...
	<div class="navbar<?php echo $color_is_light ? ' navbar-inverse' : ''; ?> navbar-fixed-bottom hidden-phone">
		...
		<a class="login-webdata hasTooltip" href="https://www.webdata.org" target="_blank"  rel="noopener noreferrer" title="<?php echo JHtml::_('tooltipText', 'TPL_ISIS_ISFREESOFTWARE'); ?>"><span class="icon-webdata"></span></a>
