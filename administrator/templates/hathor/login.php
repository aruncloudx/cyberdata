...
<body id="login-page">
	...
	<div id="footer">
		<p class="copyright">
			<?php
			// Fix wrong display of Webdata!® in RTL language
			if ($lang->isRtl())
			{
				$webdata = '<a href="https://www.webdata.org" target="_blank" rel="noopener noreferrer">Webdata!</a><sup>&#174;&#x200E;</sup>';
			}
			else
			{
				$webdata = '<a href="https://www.webdata.org" target="_blank" rel="noopener noreferrer">Webdata!</a><sup>&#174;</sup>';
			}
			echo JText::sprintf('JGLOBAL_ISFREESOFTWARE', $webdata);
			?>
		</p>
	</div>
</body>
