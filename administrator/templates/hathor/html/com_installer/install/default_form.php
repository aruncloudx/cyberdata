...
JFactory::getDocument()->addScriptDeclaration("
	...
	Webdata.submitbutton3 = function()
	{
		var form = document.getElementById('adminForm');
		...
		{
		    WebdataInstaller.showLoading();
			form.installtype.value = 'folder';
			form.submit();
		}
	};

	Webdata.submitbutton4 = function()
	{
		var form = document.getElementById('adminForm');
	...
	Webdata.submitbuttonInstallWebInstaller = function()
	{
		var form = document.getElementById('adminForm');

		form.install_url.value = 'https://appscdn.webdata.org/webapps/jedapps/webinstaller.xml';
	...
	jQuery(document).ready(function($) {
		...
		WebdataInstaller.getLoadingOverlay()
    ...
    <?php endif;?>
        ...
        <?php if ($this->showJedAndWebInstaller && !$this->showMessage) : ?>
            <div class="alert j-jed-message" style="margin-bottom: 20px; line-height: 2em; color:#333333; clear:both;">
                ...
                <input class="btn" type="button" value="<?php echo JText::_('COM_INSTALLER_INSTALL_FROM_WEB_ADD_TAB'); ?>" onclick="Webdata.submitbuttonInstallWebInstaller()" />
            </div>
        <?php endif; ?>
