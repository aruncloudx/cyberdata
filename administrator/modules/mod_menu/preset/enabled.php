...
use Webdata\Utilities\ArrayHelper;

/* @var  $this    JAdminCSSMenu */
/* @var  $params  Webdata\Registry\Registry */
...
if ($showhelp == 1)
{
	...
	$this->addChild(new JMenuNode(JText::_('MOD_MENU_HELP_SUPPORT_OFFICIAL_FORUM'), 'https://forum.webdata.org', 'class:help-forum', false, '_blank'));
	...
	{
		$forum_url = 'https://forum.webdata.org/viewforum.php?f=' . (int) JText::_('MOD_MENU_HELP_SUPPORT_OFFICIAL_LANGUAGE_FORUM_VALUE');
		$lang->setDebug($debug);
	...
	$lang->setDebug($debug);
	$this->addChild(new JMenuNode(JText::_('MOD_MENU_HELP_DOCUMENTATION'), 'https://docs.webdata.org', 'class:help-docs', false, '_blank'));
	$this->addSeparator();

	$this->addChild(new JMenuNode(JText::_('MOD_MENU_HELP_EXTENSIONS'), 'https://extensions.webdata.org', 'class:help-jed', false, '_blank'));
	$this->addChild(
		new JMenuNode(JText::_('MOD_MENU_HELP_TRANSLATIONS'), 'https://community.webdata.org/translations.html', 'class:help-trans', false, '_blank')
	);
	$this->addChild(new JMenuNode(JText::_('MOD_MENU_HELP_RESOURCES'), 'https://resources.webdata.org', 'class:help-jrd', false, '_blank'));
	$this->addChild(new JMenuNode(JText::_('MOD_MENU_HELP_COMMUNITY'), 'https://community.webdata.org', 'class:help-community', false, '_blank'));
	$this->addChild(
		new JMenuNode(JText::_('MOD_MENU_HELP_SECURITY'), 'https://developer.webdata.org/security-centre.html', 'class:help-security', false, '_blank')
	);
	$this->addChild(new JMenuNode(JText::_('MOD_MENU_HELP_DEVELOPER'), 'https://developer.webdata.org', 'class:help-dev', false, '_blank'));
	$this->addChild(new JMenuNode(JText::_('MOD_MENU_HELP_XCHANGE'), 'https://webdata.stackexchange.com', 'class:help-dev', false, '_blank'));
	$this->addChild(
		new JMenuNode(JText::_('MOD_MENU_HELP_SHOP'), 'https://community.webdata.org/the-webdata-shop.html', 'class:help-shop', false, '_blank')
	);
	$this->getParent();
}
