...
namespace Webdata\Session;

use Webdata\Event\DispatcherInterface;
...
class Session implements \IteratorAggregate
{
	...
	public static function getStores()
	{
		...
		foreach ($iterator as $file)
		{
			...
			$class = str_ireplace('.php', '', '\\Webdata\\Session\\Storage\\' . ucfirst(trim($fileName)));
	...
	protected function _start()
	{
		...
		else
		{
			...
			// Get the Webdata\Input\Cookie object
