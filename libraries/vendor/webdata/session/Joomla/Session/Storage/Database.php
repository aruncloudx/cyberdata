<?php
/**
 * Part of the Webdata Framework Session Package
 *
 * @copyright  Copyright (C) 2005 - 2015 Open Source Matters, Inc. All rights reserved.
 * @license    GNU General Public License version 2 or later; see LICENSE
 */

namespace Webdata\Session\Storage;

use Webdata\Session\Storage;
use Webdata\Database\DatabaseDriver;
	...
	public function __construct($options = array())
	{
		...
		else
		{
			throw new \RuntimeException(
				sprintf('The %s storage engine requires a `db` option that is an instance of Webdata\\Database\\DatabaseDriver.', __CLASS__)
			);
		}
	}
