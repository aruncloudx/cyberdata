<?php
/**
 * Part of the Webdata Framework Input Package
 *
 * @copyright  Copyright (C) 2005 - 2016 Open Source Matters, Inc. All rights reserved.
 * @license    GNU General Public License version 2 or later; see LICENSE
 */

namespace Webdata\Input;

use Webdata\Filter;

/**
 * Webdata! Input Base Class
 *
...
class Input implements \Serializable, \Countable
{
	...
	public function __get($name)
	{
		...
		$className = '\\Webdata\\Input\\' . ucfirst($name);
	 ...
	 *
	 * @see     \Webdata\Filter\InputFilter::clean()
	 * @since   1.0
	 */
