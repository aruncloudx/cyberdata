<?php
/**
 * Part of the Webdata Framework Registry Package
 *
 * @copyright  Copyright (C) 2005 - 2016 Open Source Matters, Inc. All rights reserved.
 * @license    GNU General Public License version 2 or later; see LICENSE
 */

namespace Webdata\Registry;
...
class Registry implements \JsonSerializable, \ArrayAccess, \IteratorAggregate, \Countable
{
	 ...
	 *
	 * @param   string  $path  Registry path (e.g. webdata.content.showauthor)
	 *
	 * @return  boolean
	 *
	 * @since   1.0
	...
	public function set($path, $value, $separator = null)
	{
		 ...
		 * nodes that occur as a result of a double separator. ex: webdata..test
	 ...
	 *
	 * @param   string  $path   Parent registry Path (e.g. webdata.content.showauthor)
	 * @param   mixed   $value  Value of entry
	 *
	 * @return  mixed  The value of the that has been set.
	 *
	...
	public function append($path, $value)
	{
		...
		/**
		 * Explode the registry path into an array and remove empty
		 * nodes that occur as a result of a double dot. ex: webdata..test
		 * Finally, re-key the array so they are sequential.
		 */
