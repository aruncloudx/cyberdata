...
abstract class AbstractDaemonApplication extends AbstractCliApplication implements LoggerAwareInterface
{
	...
	public function loadConfiguration($data)
	{
		...
		$tmp = (string) $this->get('author_name', 'Webdata Framework');
		...
		$tmp = (string) $this->get('author_email', 'admin@webdata.org');
		...
		$tmp = (string) $this->get('application_description', 'A generic Webdata Framework application.');
