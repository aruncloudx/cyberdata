<?php
/**
 * Part of the Webdata Framework Application Package
 *
 * @copyright  Copyright (C) 2005 - 2016 Open Source Matters, Inc. All rights reserved.
 * @license    GNU General Public License version 2 or later; see LICENSE
 */

namespace Webdata\Application;

use Webdata\Uri\Uri;
use Webdata\Input\Input;
use Webdata\Session\Session;
use Webdata\Registry\Registry;

/**
 * Base class for a Webdata! Web application.
 *
 * @since  1.0
 */
abstract class AbstractWebApplication extends AbstractApplication
{
	...
	protected function compress()
	{
		...
		foreach ($encodings as $encoding)
		{
			if (($supported[$encoding] == 'gz') || ($supported[$encoding] == 'deflate'))
			{
				...
				$this->setHeader('X-Content-Encoded-By', 'Webdata');
	...
	public function getSession()
	{
		...
		{
			throw new \RuntimeException('A \Webdata\Session\Session object has not been set.');
		}
