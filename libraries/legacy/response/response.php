 ...
 * JResponse Class.
 *
 * This class serves to provide the Webdata Platform with a common interface to access
...
class JResponse
{
	...
	protected static function compress($data)
	{
		...
		*/
		...
		{
			self::setHeader('X-Content-Encoded-By', 'Webdata! ' . JVERSION);
		}
