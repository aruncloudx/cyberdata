 ...
 * depends on the platform FOF is running under, e.g. the Webdata! CMS front-end,
 * the Webdata! CMS back-end, a CLI Webdata! Platform app, a bespoke Webdata!
...
interface FOFPlatformInterface
{
	 ...
	 * "webdata", "foobar123" etc. This MUST be the last part of the platform
	...
	/**
	 * Returns the human readable platform name, e.g. "Webdata!", "Webdata!
	 ...
	 * "component" is used in the sense of what we call "component" in Webdata!,
	 ...
	 * * main	The normal location of component files. For a back-end Webdata!
	 *          component this is the administrator/components/com_example
	 *          directory.
	 * * alt	The alternate location of component files. For a back-end
	 *          Webdata! component this is the front-end directory, e.g.
	 ...
	 *
	 * @param   string  $component  The name of the component. For Webdata! this
	 ...
	 * perform user authorisation. In some cases, like the Webdata! back-end,
	...
	/**
	 * Perform an ACL check. Please note that FOF uses by default the Webdata!
	...
	/**
	 * Is AJAX re-ordering supported? This is 100% Webdata!-CMS specific. All
	 ...
	 * purged by Webdata!. You MUST use this method to manually purge the cache.
	 *
	 * @return  boolean  True on success
	 */
	...
	/**
	 * Logs a deprecated practice. In Webdata! this results in the $message being output in the
