...
class FOFController extends FOFUtilsObject
{
	...
	/**
	 * Sets the access to public. Webdata! 1.5 compatibility.
	 *
	 * @return  bool
	 *
	...
	/**
	 * Sets the access to registered. Webdata! 1.5 compatibility.
	 *
	 * @return  bool
	 *
	 * @deprecated since 2.0
	...
	/**
	 * Sets the access to special. Webdata! 1.5 compatibility.
	 *
	 * @return  bool
	 *
	 * @deprecated since 2.0
	...
	protected function createView($name, $prefix = '', $type = '', $config = array())
	{
		 ...
		 * it be, there is no such thing as a format=utf in Webdata! for crying out loud) which causes a Fatal Error. So
	...
	/**
	 * Applies CSRF protection by means of a standard Webdata! token (nonce) check.
	...
	protected function _csrfProtection()
	{
		...
		// Webdata! 1.5/1.6/1.7/2.5 (classic Webdata! API) method
		...
		// Webdata! 2.5+ (Platform 12.1+) method
		if (!$hasToken)
		{
