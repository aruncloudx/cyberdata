...
/**
 * This crazy three line bit is required to convince Webdata! to load JDatabaseInterface which is on the same file as the
 * abstract JDatabaseDriver class for reasons that beat me. It makes no sense. Furthermore, jimport on Webdata! 3.4
...
/**
 * Webdata! pass-through database driver.
 */
class FOFDatabaseDriverWebdata extends FOFDatabase implements FOFDatabaseInterface
{
