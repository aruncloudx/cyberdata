 ...
 *
 * This file is adapted from the Webdata! Platform. It is used to iterate a database cursor returning FOFTable objects
...
class FOFDatabaseInstaller
{
	...
	public function updateSchema()
	{
		 ...
		 * converted to the correct collation (utf8mb4_unicode_ci or utf8_general_ci) depending on whether your Webdata!
	 ...
	 *
	 * We use our own method so we can be site it works even on Webdata! 3.4 or earlier, where UTF8MB4 support is not
	 * implemented.
	 *
	...
	private function convertUtf8mb4QueryToUtf8($query)
	{
		...
		$to = array(
			'utf8_general_ci', // Yeah, we convert utf8mb4_unicode_ci to utf8_general_ci per Webdata!'s conventions
			'utf8_',
			'utf8',
		);
	...
	private function convertUtf8QueryToUtf8mb4($query)
	{
		...
		$to = array(
			'utf8mb4_unicode_ci', // Yeah, we convert utf8_general_ci to utf8mb4_unicode_ci per Webdata!'s conventions
			'utf8mb4_',
			'utf8mb4',
		);
