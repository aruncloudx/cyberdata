...
/**
 * Default Webdata! 1.5, 1.7, 2.5 view renderer class
 *
 * @package  FrameworkOnFramework
 * @since    2.0
 */
class FOFRenderWebdata extends FOFRenderAbstract
{
	/**
	...
	public function preRender($view, $task, $input, $config = array())
	{
		...
		echo '<div id="akeeba-renderwebdata" class="' . implode($classes, ' ') . "\">\n";
	...
	public function postRender($view, $task, $input, $config = array())
	{
		...
		echo "</div>\n";    // Closes akeeba-renderwebdata div
	}
	...
	protected function renderFormBrowse(FOFForm &$form, FOFModel $model, FOFInput $input)
	{
		...
		if ($show_header || $show_filters)
		{
			...
			{
				// Make sure we have a header field. Under Webdata! 2.5 we cannot
...
JS;
	...
	protected function renderButtons($view, $task, $input, $config = array())
	{
		...
		// Delete faux links, since if SEF is on, Webdata will follow the link instead of submitting the form
