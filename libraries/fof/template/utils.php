...
class FOFTemplateUtils
{
	...
	/**
	 * Creates a SEF compatible sort header. Standard Webdata function will add a href="#" tag, so with SEF
	 ...
	 * @param   int     $style     Rendering style; please refer to Webdata!'s code for more information
	 *
