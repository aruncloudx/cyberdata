...
abstract class FOFView extends FOFUtilsObject
{
	 ...
	 *
	 * This function searches for Webdata! version override templates. For example,
	 * if you have run this under Webdata! 3.0 and you try to load
	...
	{
		// Automatically check for a Webdata! version specific override
	 ...
	 * Webdata! version overrides. A little slice of awesome pie!
	 *
	...
	protected function findRenderer()
	{
		...
		if (empty(self::$renderers) || !class_exists('FOFRenderWebdata', false))
		{
	...
	public function loadHelper($hlp = null)
	{
		...
		// Load the template script using the default Webdata! features
        $filesystem = FOFPlatform::getInstance()->getIntegrationObject('filesystem');
