...
class FOFFormFieldRules extends JFormFieldRules implements FOFFormField
{
    ...
    /**
	 * At the timing of this writing (2013-12-03), the Webdata "rules" field is buggy. When you are
	 * dealing with a new record it gets the default permissions from the root asset node, which
	 * is fine for the default permissions of Webdata articles, but unsuitable for third party software.
