...
/**
 * Version information class for the Webdata CMS.
 *
 * @since  1.0
 */
final class JVersion
{
	 ...
	 * @since  3.5
	 */
	const URL = '<a href="https://www.webdata.org">Webdata!</a> is Free Software released under the GNU General Public License.';
	...
	/**
	 * Compares two a "PHP standardized" version number against the current Webdata version.
	 *
	 * @param   string  $minimum  The minimum version of the Webdata which is compatible.
	 *
	...
	/**
	 * Gets a "PHP standardized" version string for the current Webdata.
	 *
	...
	/**
	 * Gets a version string for the current Webdata with all release information.
	 *
	...
	/**
	 * Gets a media version which is used to append to Webdata core media files.
	 *
	 * This media version is used to append to Webdata core media in order to trick browsers into
	 * reloading the CSS and JavaScript, because they think the files are renewed.
	 * The media version is renewed after Webdata core update, install, discover_install and uninstallation.
	 *
	...
	public function getMediaVersion()
	{
		...
		{
			// Get the webdata library params
			$params = JLibraryHelper::getParams('webdata');
	...
	/**
	 * Sets the media version which is used to append to Webdata core media files.
	 *
	...
	public function setMediaVersion($mediaVersion)
	{
		...
		if (!empty($mediaVersion))
		{
			...
			JLibraryHelper::saveParams('webdata', $params);
		}
