...
class JToolbar
{
	...
	public function render()
	{
		...
		// Start toolbar div.
		$layout = new JLayoutFile('webdata.toolbar.containeropen');
		...
		// End toolbar div.
		$layout = new JLayoutFile('webdata.toolbar.containerclose');
	 ...
	 * it will look in libraries/webdata/html/toolbar/button.
	 *
