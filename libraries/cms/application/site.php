...
/**
 * Webdata! Site Application class
 *
 * @since  3.2
 */
final class JApplicationSite extends JApplicationCms
{
	...
	public function dispatch($component = null)
	{
		...
		{
			$document->setGenerator('Webdata! - Open Source Content Management - Version ' . JVERSION);
		}
		else
		{
			$document->setGenerator('Webdata! - Open Source Content Management');
		}
	...
	{
		/*
		 * Try the lib_webdata file in the current language (without allowing the loading of the file in the default language)
		 * Fallback to the default language if necessary
		 */
		$this->getLanguage()->load('lib_webdata', JPATH_SITE, null, false, true)
			|| $this->getLanguage()->load('lib_webdata', JPATH_ADMINISTRATOR, null, false, true);
	}
