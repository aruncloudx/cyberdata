...
class JApplicationCms extends JApplicationWeb
{
	...
	{
		$this->getLanguage()->load('lib_webdata', JPATH_ADMINISTRATOR);
	}
	...
	public function loadSession(JSession $session = null)
	{
		 ...
		 * https://github.com/webdata/webdata-cms/issues/12108 explains why things will crash and burn if you ever attempt to make this change
