 ...
 *
 * @link   https://docs.webdata.org/Special:MyLanguage/Sharing_layouts_across_views_or_extensions_with_JLayout
 * @since  3.0
 */
class JLayoutFile extends JLayoutBase
{
	...
	{
		JLoader::import('webdata.filesystem.path');
	...
	public function getDefaultIncludePaths()
	{
		...
		// (4) Standard Webdata! layouts overriden
