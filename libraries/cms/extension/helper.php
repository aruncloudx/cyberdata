...
class JExtensionHelper
{
	...
	protected static $coreExtensions = array(
		...
		array('component', 'com_webdataupdate', '', 1),
		...
		array('plugin', 'webdata', 'authentication', 0),
		...
		array('plugin', 'webdata', 'content', 0),
		...
		array('plugin', 'webdata', 'extension', 0),
		...
		array('plugin', 'webdataupdate', 'quickicon', 0),
