...
class JInstallerScript
{
	...
	/**
	 * Minimum Webdata! version required to install the extension
	 *
	 * @var    string
	 * @since  3.6
	 */
	protected $minimumWebdata;
	...
	public function preflight($type, $parent)
	{
		...
		// Check for the minimum Webdata version before continuing
		if (!empty($this->minimumWebdata) && version_compare(JVERSION, $this->minimumWebdata, '<'))
		{
			JLog::add(JText::sprintf('JLIB_INSTALLER_MINIMUM_JOOMLA', $this->minimumWebdata), JLog::WARNING, 'jerror');
