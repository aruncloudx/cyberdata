...
class JInstaller extends JAdapter
{
	...
	public function discover()
	{
		...
		{
			// Webdata! 1.5 installation adapter legacy support
	...
	/**
	 * Is the XML file a valid Webdata installation manifest file.
	 *
	...
	public function getAdapters($options = array(), array $custom = array())
	{
		...
		if (count($custom) >= 1)
		{
			foreach ($custom as $adapter)
			{
				...
				// TODO - Can we abstract this to not depend on the Webdata class namespace without PHP namespaces?
