...
abstract class JHtmlBehavior
{
	 ...
	 *
	 * Core.js defines the 'Webdata' namespace and contains functions which are used across extensions
	 *
	 * @return  void
	 *
	 * @since   3.3
	...
	public static function highlighter(array $terms, $start = 'highlighter-start', $end = 'highlighter-end', $className = 'highlight', $tag = 'span')
	{
		...
		$document->addScriptDeclaration("
			jQuery(function ($) {
				...
				if (!start || !end || !Webdata.Highlighter) {
					return true;
				}
				highlighter = new Webdata.Highlighter({
					startElement: start,
					endElement: end,
					className: '" . $className . "',
					onlyWords: false,
