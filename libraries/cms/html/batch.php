...
abstract class JHtmlBatch
{
	 ...
	 * @since       1.7
	 *
	 * @deprecated  4.0 instead of JHtml::_('batch.access'); use JLayoutHelper::render('webdata.html.batch.access', array());
	 */
	public static function access()
	{
		JLog::add('The use of JHtml::_("batch.access") is deprecated use JLayout instead.', JLog::WARNING, 'deprecated');

		return JLayoutHelper::render('webdata.html.batch.access', array());
	}
	 ...
	 * @since       1.7
	 *
	 * @deprecated  4.0 instead of JHtml::_('batch.item'); use JLayoutHelper::render('webdata.html.batch.item', array('extension' => 'com_XXX'));
	 */
	public static function item($extension)
	{
		...
		return JLayoutHelper::render('webdata.html.batch.item', $displayData);
	}
	 ...
	 * @since       2.5
	 *
	 * @deprecated  4.0 instead of JHtml::_('batch.language'); use JLayoutHelper::render('webdata.html.batch.language', array());
	 */
	public static function language()
	{
		JLog::add('The use of JHtml::_("batch.language") is deprecated use JLayout instead.', JLog::WARNING, 'deprecated');

		return JLayoutHelper::render('webdata.html.batch.language', array());
	}
	 ...
	 * @since       2.5
	 *
	 * @deprecated  4.0 instead of JHtml::_('batch.user'); use JLayoutHelper::render('webdata.html.batch.user', array());
	 */
	public static function user($noUser = true)
	{
		...
		return JLayoutHelper::render('webdata.html.batch.user', $displayData);
	}
	 ...
	 * @since       3.1
	 *
	 * @deprecated  4.0 instead of JHtml::_('batch.tag'); use JLayoutHelper::render('webdata.html.batch.tag', array());
	 */
	public static function tag()
	{
		JLog::add('The use of JHtml::_("batch.tag") is deprecated use JLayout instead.', JLog::WARNING, 'deprecated');

		return JLayoutHelper::render('webdata.html.batch.tag', array());
	}
}
