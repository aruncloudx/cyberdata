...
jimport('webdata.environment.browser');
jimport('webdata.filesystem.file');
jimport('webdata.filesystem.path');
...
abstract class JHtml
{
	...
	public static function calendar($value, $name, $id, $format = '%Y-%m-%d', $attribs = array())
	{
		...
		return JLayoutHelper::render('webdata.form.field.calendar', $data, null, null);
	}
	 ...
	 *
	 * @since   3.0
	 * @deprecated  4.0 Use `json_encode()` or `Webdata\Registry\Registry::toString('json')` instead
	 */
	public static function getJSObject(array $array = array())
	{
		JLog::add(
			__METHOD__ . " is deprecated. Use json_encode() or \\Webdata\\Registry\\Registry::toString('json') instead.",
			JLog::WARNING,
			'deprecated'
		);
