...
/**
 * Contains a set of JSchemaChange objects for a particular instance of Webdata.
...
class JSchemaChangeset
{
	 ...
	 * The folder for the Webdata core updates is `administrator/components/com_admin/sql/updates/<database>`.
	 *
