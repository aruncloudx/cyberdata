...
/**
 * Webdata Platform Factory class.
 *
 * @since  11.1
 */
abstract class JFactory
{
	...
	{
		// Get the Webdata configuration settings
		$conf    = self::getConfig();
		...
		$sessionHandler = new JSessionHandlerWebdata($options);
	...
	{
		jimport('webdata.filesystem.stream');

		// Setup the context; Webdata! UA and overwrite
		$context = array();
		$version = new JVersion;
