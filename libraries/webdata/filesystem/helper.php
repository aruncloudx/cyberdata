...
class JFilesystemHelper
{
	 ...
	 * Also includes Webdata! streams as well as PHP streams
	 *
	...
	/**
	 * Determine if a stream is a Webdata stream.
	 *
	 * @param   string  $streamname  The name of a stream
	 *
	 * @return  boolean  True for a Webdata Stream
	 *
	 * @since   11.1
	 */
	public static function isWebdataStream($streamname)
	{
