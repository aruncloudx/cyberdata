...
jimport('webdata.updater.updateadapter');
		...
		if (isset($this->latest))
		{
			if (isset($this->latest->client) && strlen($this->latest->client))
			{
				if (is_numeric($this->latest->client))
				{
					...
					// <client> has to be 'administrator' or 'site', numeric values are deprecated. See https://docs.webdata.org/Special:MyLanguage/Design_of_JUpdate
					JLog::add(
