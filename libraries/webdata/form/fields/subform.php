 ...
 * 		layout="webdata.form.field.subform.repeatable-table" groupByFieldset="false" component="com_example" client="site"
...
class JFormFieldSubform extends JFormField
{
	 ...
	 * @var  string
	 */
	protected $layout = 'webdata.form.field.subform.default';
		...
		switch ($name)
		{
			...
			case 'layout':
				...
				if (!$this->layout)
				{
					...
					$this->layout = !$this->multiple ? 'webdata.form.field.subform.default' : 'webdata.form.field.subform.repeatable';
				}
