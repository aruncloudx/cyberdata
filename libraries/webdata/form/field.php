...
use Webdata\String\Normalise;
use Webdata\String\StringHelper;

/**
 * Abstract Form Field class for the Webdata Platform.
 *
 * @since  11.1
 */
abstract class JFormField
{
	 ...
	 * @var  string
	 */
	protected $renderLayout = 'webdata.form.renderfield';
	 ...
	 * @var  string
	 */
	protected $renderLabelLayout = 'webdata.form.renderlabel';
