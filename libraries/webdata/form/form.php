...
/**
 * Form Class for the Webdata Platform.
 *
...
class JForm
{
	 ...
	 * the form control is set to 'webdata' however, the fields would be rendered like:
	 * `<input name="webdata[foo]" />` and `<input name="webdata[bar]" />`.
	 *
