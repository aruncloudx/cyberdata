...
use Webdata\String\StringHelper;
 ...
 *
 * @since       11.1
 * @deprecated  4.0 Use Webdata\Utilities\ArrayHelper instead
 */
abstract class JArrayHelper
{
	 ...
	 *
	 * @since   11.1
	 * @deprecated  4.0 Use Webdata\Utilities\ArrayHelper::toInteger instead
	 */
	 ...
	 *
	 * @since   11.1
	 * @deprecated  4.0 Use Webdata\Utilities\ArrayHelper::toObject instead
	 */
	public static function toObject(&$array, $class = 'stdClass', $recursive = true)
	{
		...
		{
			JLog::add('This method is typehinted to be an array in \Webdata\Utilities\ArrayHelper::toObject.', JLog::WARNING, 'deprecated');
		}
	 ...
	 *
	 * @since   11.1
	 * @deprecated  4.0 Use Webdata\Utilities\ArrayHelper::toString instead
	 */
	public static function toString($array = null, $inner_glue = '=', $outer_glue = ' ', $keepOuterKey = false)
	{
		...
		{
			JLog::add('This method is typehinted to be an array in \Webdata\Utilities\ArrayHelper::toString.', JLog::WARNING, 'deprecated');
		}
	 ...
	 *
	 * @since   11.1
	 * @deprecated  4.0 Use Webdata\Utilities\ArrayHelper::fromObject instead
	 */
	 ...
	 *
	 * @since   11.1
	 * @deprecated  4.0 Use Webdata\Utilities\ArrayHelper::getColumn instead
	 */
	public static function getColumn(&$array, $index)
	{
		...
		{
			JLog::add('This method is typehinted to be an array in \Webdata\Utilities\ArrayHelper::getColumn.', JLog::WARNING, 'deprecated');
		}
	 ...
	 *
	 * @since   11.1
	 * @deprecated  4.0 Use Webdata\Utilities\ArrayHelper::getValue instead
	 */
	 ...
	 *
	 * @since   12.3
	 * @deprecated  4.0 Use Webdata\Utilities\ArrayHelper::invert instead
	 */
	 ...
	 *
	 * @since   11.1
	 * @deprecated  4.0 Use Webdata\Utilities\ArrayHelper::isAssociative instead
	 */
	 ...
	 *
	 * @since   11.3
	 * @deprecated  4.0 Use Webdata\Utilities\ArrayHelper::pivot instead
	 */
	public static function pivot($source, $key = null)
	{
		...
		{
			JLog::add('This method is typehinted to be an array in \Webdata\Utilities\ArrayHelper::pivot.', JLog::WARNING, 'deprecated');
		}
	 ...
	 *
	 * @since   11.1
	 * @deprecated  4.0 Use Webdata\Utilities\ArrayHelper::sortObjects instead
	 */
	 ...
	 * @since   11.2
	 * @deprecated  4.0 Use Webdata\Utilities\ArrayHelper::arrayUnique instead
	 */
