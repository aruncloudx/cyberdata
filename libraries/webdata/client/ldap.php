...
use Webdata\Ldap\LdapClient;

/**
 * LDAP client class
 *
 * @since       12.1
 * @deprecated  4.0  Use Webdata\Ldap\LdapClient instead
 */
class JClientLdap extends LdapClient
{
	...
	{
		JLog::add('JClientLdap is deprecated. Use Webdata\Ldap\LdapClient instead.', JLog::WARNING, 'deprecated');
