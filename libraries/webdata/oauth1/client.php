...
/**
 * Webdata Platform class for interacting with an OAuth 1.0 and 1.0a server.
 *
 * @since       13.1
 * @deprecated  4.0  Use the `webdata/oauth1` framework package that will be bundled instead
 */
