...
class JApplicationDaemon extends JApplicationCli
{
	...
	public function loadConfiguration($data)
	{
		...
		$tmp = (string) $this->config->get('author_name', 'Webdata Platform');
		...
		$tmp = (string) $this->config->get('author_email', 'admin@webdata.org');
		...
		$tmp = (string) $this->config->get('application_description', 'A generic Webdata Platform application.');
