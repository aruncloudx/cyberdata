 ...
 *
 * @since       11.1
 * @deprecated  4.0  Use {@link \Webdata\String\StringHelper} instead unless otherwise noted.
 */
abstract class JString extends StringHelper
{
	 ...
	 * @since   11.1
	 * @deprecated  4.0 (CMS) - Use {@link \Webdata\Uri\UriHelper::parse_url()} instead.
	 */
	public static function parse_url($url)
	{
		JLog::add('JString::parse_url has been deprecated. Use \\Webdata\\Uri\\UriHelper::parse_url.', JLog::WARNING, 'deprecated');

		return \Webdata\Uri\UriHelper::parse_url($url);
	}
}
