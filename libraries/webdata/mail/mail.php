...
/**
 * Email Class.  Provides a common interface to send email from the Webdata! Platform
 *
 * @since  11.1
 */
class JMail extends PHPMailer
{
	...
	public function __construct($exceptions = true)
	{
		...
		$this->setLanguage('webdata', __DIR__ . '/language');
	 ...
	 * values, use an id string that is not 'Webdata'.
	 *
	 ...
	 * @since   11.1
	 */
	public static function getInstance($id = 'Webdata', $exceptions = true)
	{
	...
	{
		// Prefer the Webdata configured sendmail path and default to the configured PHP path otherwise
