...
class JText
{
	 ...
	 *
	 * Examples:
	 * `<script>alert(Webdata.JText._('<?php echo JText::_("JDEFAULT", array("script"=>true)); ?>'));</script>`
	 ...
	 *
	 * Examples:
	 * `<script>alert(Webdata.JText._('<?php echo JText::plural("COM_PLUGINS_N_ITEMS_UNPUBLISHED", 1, array("script"=>true)); ?>'));</script>`
	...
	public static function script($string = null, $jsSafe = false, $interpretBackSlashes = true)
	{
		...
		if ($string !== null)
		{
			...
			// Update Webdata.JText script options
			JFactory::getDocument()->addScriptOptions('webdata.jtext', static::$strings, false);
		}
