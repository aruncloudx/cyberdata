<?php
/**
 * Bootstrap file for the Webdata Platform [with legacy libraries].  Including this file into your application
 * will make Webdata Platform libraries [including legacy libraries] available for use.
 *
...
// Make sure that the Webdata Loader has been successfully loaded.
if (!class_exists('JLoader'))
{
	throw new RuntimeException('Webdata Loader not loaded.');
}
...
JLoader::register('JText', JPATH_PLATFORM . '/webdata/language/text.php');
JLoader::register('JRoute', JPATH_PLATFORM . '/webdata/application/route.php');

// Check if the JsonSerializable interface exists already
if (!interface_exists('JsonSerializable'))
{
	JLoader::register('JsonSerializable', JPATH_PLATFORM . '/vendor/webdata/compat/src/JsonSerializable.php');
}
