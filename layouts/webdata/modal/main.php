...
if (isset($params['url']))
{
	$iframeHtml = JLayoutHelper::render('webdata.modal.iframe', $displayData);
...
<div id="<?php echo $selector; ?>" <?php echo ArrayHelper::toString($modalAttributes); ?>>
	...
	{
		echo JLayoutHelper::render('webdata.modal.header', $displayData);
	}

	// Body
	echo JLayoutHelper::render('webdata.modal.body', $displayData);

	// Footer
	if (isset($params['footer']))
	{
		echo JLayoutHelper::render('webdata.modal.footer', $displayData);
	}
	?>
</div>
