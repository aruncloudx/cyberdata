...
<div class="pagination pagination-toolbar clearfix" style="text-align: center;">
	...
	<?php if ($showPagesLinks && (!empty($pages))) : ?>
		<ul class="pagination-list">
			<?php
				echo JLayoutHelper::render('webdata.pagination.link', $pages['start']);
				echo JLayoutHelper::render('webdata.pagination.link', $pages['previous']); ?>
			<?php foreach ($pages['pages'] as $k => $page) : ?>

				<?php $output = JLayoutHelper::render('webdata.pagination.link', $page); ?>
			...
			<?php endforeach; ?>
			<?php
				echo JLayoutHelper::render('webdata.pagination.link', $pages['next']);
				echo JLayoutHelper::render('webdata.pagination.link', $pages['end']); ?>
		</ul>
	<?php endif; ?>
